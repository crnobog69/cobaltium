...
3. Идите на `chrome://extensions/` или `brave://extensions/` (ако користите браве претраживач) у прегледачу.
4. Укључите `Developer mode`.
5. Кликните на `Load unpacked` и изаберите фасциклу.
